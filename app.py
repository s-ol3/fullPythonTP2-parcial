...
catalogo = Catalogo(host='ols.mysql.pythonanywhere-services.com', user='ols', password='33xx5577', database='ols$miapp')
...
RUTA_DESTINO = '/home/ols/mysite/static/imagenes'
